...
class MealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meal" do
    assert_difference("Meal.count") do
      post meals_url, params: { meal: { day: @meal.day, meal: @meal.meal, menu_id: @meal.menu_id } }
    end
  ...
  test "should update meal" do
    patch meal_url(@meal), params: { meal: { day: @meal.day, meal: @meal.meal, menu_id: @meal.menu_id } }
